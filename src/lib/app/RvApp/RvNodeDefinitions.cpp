...
namespace Rv
{
    ...
    void addRvNodeDefinitions(NodeManager* m)
    {
        ...
        if (ignoreICC)
            usingICC = (strcmp(ignoreICC, "0") == 0);

        m->addDefinition(new NodeDefinition("Adaptor", 1, false, "adaptor", newIPNode<AdaptorIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("Root", 1, false, "root", newIPNode<RootIPNode>, "", "", emptyIcon, false));

        // RvSession protocolVersion is overwritten in the session write request
        m->addDefinition(
            new NodeDefinition("RVSession", 4, false, "session", newIPNode<SessionIPNode>, "Session container", "", emptyIcon, false));

        {
            NodeDefinition* def = new NodeDefinition("RVSequenceGroup", 1, true, "sequenceGroup", newIPNode<SequenceGroupIPNode>,
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVStackGroup", 1, true, "stackGroup", newIPNode<StackGroupIPNode>,
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVFolderGroup", 1, true, "folderGroup", newIPNode<FolderGroupIPNode>,
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVLayoutGroup", 1, true, "layoutGroup", newIPNode<LayoutGroupIPNode>,
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVRetimeGroup", 1, true, "retimeGroup", newIPNode<RetimeGroupIPNode>,
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVSwitchGroup", 1, true, "switchGroup", newIPNode<SwitchGroupIPNode>,
                                                     "Select one of several inputs", "", emptyIcon);

            def->declareProperty<StringProperty>("defaults.switchType", "RVSwitch");
            m->addDefinition(def);
        }

        m->addDefinition(new NodeDefinition("RVRetime", 1, false, "retime", newIPNode<RetimeIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("RVSwitch", 1, false, "switch", newIPNode<SwitchIPNode>, "Select one of several inputs", "",
                                            emptyIcon, false));
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVLookPipelineGroup", 1, true, "pipeline", newIPNode<PipelineGroupIPNode>,
                                                     "Managed Single Input Pipeline for Source Look", "", emptyIcon, false);
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVLinearizePipelineGroup", 1, true, "pipeline", newIPNode<PipelineGroupIPNode>,
                                                     "Managed Single Input Pipeline for Source Linearization", "", emptyIcon, false);

            vector<string> linearizeDefaults;
            linearizeDefaults.push_back("RVLinearize");
            if (usingICC)
                linearizeDefaults.push_back("ICCLinearizeTransform");
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVDisplayPipelineGroup", 1, true, "pipeline", newIPNode<PipelineGroupIPNode>,
                                                     "Managed Single Input Pipeline for Display", "", emptyIcon, false);
        ...
        {
            NodeDefinition* def = new NodeDefinition("RVViewPipelineGroup", 1, true, "pipeline", newIPNode<PipelineGroupIPNode>,
                                                     "Managed Single Input Pipeline for View Group", "", emptyIcon, false);
        ...
        m->addDefinition(new NodeDefinition("PipelineGroup", 1, true, "pipeline", newIPNode<PipelineGroupIPNode>,
                                            "Managed Single Input Pipeline", "", emptyIcon, true));

        m->addDefinition(new NodeDefinition("RVCache", 1, false, "cache", newIPNode<CacheIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("RVCacheLUT", 1, false, "cacheLUT", newIPNode<CacheLUTIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("RVChannelMap", 1, false, "channelMap", newIPNode<ChannelMapIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("RVColor", 2, false, "color", newIPNode<ColorIPNode>, "", "", emptyIcon, true));

        m->addDefinition(new NodeDefinition("RVCDL", 1, false, "color", newIPNode<ColorCDLIPNode>, "", "", emptyIcon, true));

        m->addDefinition(new NodeDefinition("RVDispTransform2D", 1, false, "dispTransform2D", newIPNode<DispTransform2DIPNode>, "", "",
                                            emptyIcon, false));

        {
            NodeDefinition* def =
                new NodeDefinition("RVDisplayColor", 1, false, "displayColor", newIPNode<DisplayIPNode>, "", "", emptyIcon, false);
        ...
        {
            NodeDefinition* def =
                new NodeDefinition("RVDisplayGroup", 1, true, "displayGroup", newIPNode<DisplayGroupIPNode>, "", "", emptyIcon, false);
        ...
        {
            NodeDefinition* def =
                new NodeDefinition("RVViewGroup", 1, true, "viewGroup", newIPNode<RvViewGroupIPNode>, "", "", emptyIcon, false);
        ...
        m->addDefinition(
            new NodeDefinition("RVDisplayStereo", 1, false, "displayStereo", newIPNode<DisplayStereoIPNode>, "", "", emptyIcon, false));

        {
            NodeDefinition* def =
                new NodeDefinition("RVFileSource", 1, false, "fileSource", newIPNode<FileSourceIPNode>, "", "", emptyIcon, false);
        ...
        m->addDefinition(
            new NodeDefinition("RVImageSource", 1, false, "imageSource", newIPNode<ImageSourceIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("RVFormat", 1, false, "format", newIPNode<FormatIPNode>, "", "", emptyIcon, false));

        {
            NodeDefinition* def =
                new NodeDefinition("RVLinearize", 1, false, "linearize", newIPNode<FileSpaceLinearizeIPNode>, "", "", emptyIcon, false);
        ...
        m->addDefinition(new NodeDefinition("RVLookLUT", 1, false, "look", newIPNode<LUTIPNode>, "", "", emptyIcon, false));

        m->addDefinition(
            new NodeDefinition("RVPrimaryConvert", 1, false, "primaryConvert", newIPNode<PrimaryConvertIPNode>, "", "", emptyIcon, true));

        {
            NodeDefinition* def = new NodeDefinition("OCIO", 1, false, "OCIO", newIPNode<OCIOIPNode>, "", "", emptyIcon, true);
        ...
        {
            NodeDefinition* def =
                new NodeDefinition("OCIODisplay", 1, false, "OCIODisplay", newIPNode<OCIOIPNode>, "", "", emptyIcon, true);
        ...
        {
            NodeDefinition* def = new NodeDefinition("OCIOLook", 1, false, "OCIOLook", newIPNode<OCIOIPNode>, "", "", emptyIcon, true);
        ...
        {
            NodeDefinition* def = new NodeDefinition("OCIOFile", 1, false, "OCIOFile", newIPNode<OCIOIPNode>, "", "", emptyIcon, true);
        ...
        {
            NodeDefinition* def = new NodeDefinition("SYNLinearize", 1, false, "sclin", newIPNode<OCIOIPNode>, "", "", emptyIcon, true);
        ...
        {
            NodeDefinition* def = new NodeDefinition("SYNDisplay", 1, false, "scdsp", newIPNode<OCIOIPNode>, "", "", emptyIcon, true);

            def->declareProperty<StringProperty>("defaults.function", "syndisplay");
            m->addDefinition(def);
        }

        m->addDefinition(new NodeDefinition("RVOverlay", 1, false, "overlay", newIPNode<OverlayIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("RVPaint", 3, false, "paint", newIPNode<PaintIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("RVSequence", 1, false, "sequence", newIPNode<SequenceIPNode>, "", "", emptyIcon, false));

        {
            NodeDefinition* def =
                new NodeDefinition("RVSoundTrack", 1, false, "soundTrack", newIPNode<SoundTrackIPNode>, "", "", emptyIcon, false);
        ...
        {
            NodeDefinition* def =
                new NodeDefinition("RVSourceGroup", 1, true, "sourceGroup", newIPNode<SourceGroupIPNode>, "", "", emptyIcon);
        ...
        m->addDefinition(
            new NodeDefinition("RVSourceStereo", 1, false, "sourceStereo", newIPNode<SourceStereoIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("RVStack", 1, false, "stack", newIPNode<StackIPNode>, "", "", emptyIcon, false));

        m->addDefinition(
            new NodeDefinition("RVTransform2D", 1, false, "transform2D", newIPNode<Transform2DIPNode>, "", "", emptyIcon, false));

        m->addDefinition(
            new NodeDefinition("AudioWaveform", 1, false, "audioWaveform", newIPNode<AudioTextureIPNode>, "", "", emptyIcon, false));

        m->addDefinition(new NodeDefinition("Dynamic", 1, true, "dynamic", newIPNode<DynamicIPNode>, "", "", emptyIcon));
    }

    void setScaleOnAll(const IPGraph& graph, float scale)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();

        for (IPGraph::NodeMap::const_iterator i = nodeMap.begin(); i != nodeMap.end(); ++i)
        {
            if (FormatIPNode* node = dynamic_cast<FormatIPNode*>((*i).second))
            {
                if (FloatProperty* fp = node->property<FloatProperty>("geometry", "scale"))
                {
                    fp->front() = scale;
                }
            }
    ...
    void setLogLinOnAll(const IPGraph& graph, bool val, int type)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void setSRGBLinOnAll(const IPGraph& graph, bool val)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void setRec709LinOnAll(const IPGraph& graph, bool val)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void setGammaOnAll(const IPGraph& graph, float gamma)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void setFileGammaOnAll(const IPGraph& graph, float gamma)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void setFileExposureOnAll(const IPGraph& graph, float e)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void setFlipFlopOnAll(const IPGraph& graph, bool setFlip, bool flip, bool setFlop, bool flop)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void setChannelMapOnAll(const IPGraph& graph, const vector<string>& chmap)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void fitAllInputs(const IPGraph& graph, int w, int h)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
    ...
    void resizeAllInputs(const IPGraph& graph, int w, int h)
    {
        const IPGraph::NodeMap& nodeMap = graph.nodeMap();
