...
namespace IPCore
{
    ...
    OutputGroupIPNode::OutputGroupIPNode(const std::string& name, const NodeDefinition* def, IPGraph* graph, GroupIPNode* group)
    ...
    IPImage* OutputGroupIPNode::evaluate(const Context& context) { return DisplayGroupIPNode::evaluate(context); }
