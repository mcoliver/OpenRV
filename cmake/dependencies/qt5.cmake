...
IF(RV_TARGET_DARWIN)
  FIND_PROGRAM(QT_MACDEPLOYQT_EXECUTABLE macdeployqt HINTS "${RV_DEPS_QT5_LOCATION}/bin")
  IF(NOT QT_MACDEPLOYQT_EXECUTABLE)
    MESSAGE(FATAL_ERROR "macdeployqt not found in ${RV_DEPS_QT5_LOCATION}/bin")
  ENDIF()
ENDIF()
