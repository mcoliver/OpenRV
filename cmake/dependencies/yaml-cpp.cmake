...
# Try to find system yaml-cpp first, as OCIO might have used it.
...
IF(yaml-cpp_FOUND)
  ...
  # Still depend on OCIO as it is a major dependency sibling
...
ELSE()
  MESSAGE(STATUS "System yaml-cpp not found, assuming OCIO internal build.")
